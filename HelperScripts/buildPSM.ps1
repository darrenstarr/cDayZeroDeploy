...
$content += (Get-Content -Raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\DSCResources\cNATRule\cNATRule.ps1')).TrimEnd() + "`n"
...
$content += (Get-Content -Raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\DSCResources\cDifferencingVHD\cDifferencingVHD.ps1')).TrimEnd() + "`n"
$content += (Get-Content -Raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\DSCResources\cGuestRegistryKey\cGuestRegistryKey.ps1')).TrimEnd() + "`n"
$content += (Get-Content -raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\HelperScripts\MOFUtilities\parseMOF.ps1')) + "`n"
$content += (Get-Content -raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\HelperScripts\MOFUtilities\cDSCResourceManifestItem.ps1')) + "`n" 
$content += (Get-Content -raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\HelperScripts\MOFUtilities\cDSCResourceInformation.ps1')) + "`n"
$content += (Get-Content -raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\HelperScripts\MOFUtilities\cOfflineMOFDependencyInstaller.ps1')) + "`n" 
$content += (Get-Content -Raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\DSCResources\cVHDFileSystem\Classes\cVHDFileSystem.ps1')).TrimEnd() + "`n"
$content += (Get-Content -Raw -Path (Join-Path -Path $PSScriptRoot -ChildPath '..\DSCResources\cWindowsVHD\cWindowsVHD.ps1')).TrimEnd() + "`n"
